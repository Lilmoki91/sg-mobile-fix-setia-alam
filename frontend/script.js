...
function initGallery() {
  ...
  const images = [
    ["https://i.postimg.cc/tggRh5vg/sg-mobile-1.webp", "Gambar Kedai 1"],
    ["https://i.postimg.cc/gJCYbPzK/sg-mobile-2.webp", "Gambar Kedai 2"],
    ["https://i.postimg.cc/DfgY1LN5/sg-mobile(3).webp", "Gambar Kedai 3"],
  ...
  shareButton.addEventListener("click", async () => {
    ...
    try {
      if (navigator.share) {
        ...
        shareButton.innerHTML = '<i class="fas fa-check mr-2"></i> Link Disalin';
        setTimeout(() => {
          shareButton.innerHTML = originalContent;
        }, 2000);
      }
    } catch {
      // Perkongsian dibatalkan oleh pengguna.
    }
  });
}
